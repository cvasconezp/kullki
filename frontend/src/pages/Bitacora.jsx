...
export default function Bitacora() {
  ...
  const esSocio = (getSesion() || {}).rol === "socio";
  ...
  return (
    <>
      ...
      <p style={{ color: "var(--tinta-suave)", fontSize: 13, margin: "0 0 8px" }}>
        {esSocio
          ? "Por tu privacidad, ves los movimientos que te conciernen y los eventos generales de la caja."
          : "Todo movimiento queda registrado para auditoría. La directiva y el tesorero ven la bitácora completa."}
      </p>
